package com.marlon.mpandroidchart;
...
//        lineChart.setScaleYEnabled(false);
        ...
        legend.setTextColor(BaseApplication.getInstance().getResources().getColor(R.color.colorLineCharLegendText));
        //显示位置
        ...
        setXAxis(0f, 130f, 10f, 6, Color.TRANSPARENT, 0,
                BaseApplication.getInstance().getResources().getColor(R.color.colorLineChatText), 11,
                BaseApplication.getInstance().getResources().getColor(R.color.colorLineChatGrid));
