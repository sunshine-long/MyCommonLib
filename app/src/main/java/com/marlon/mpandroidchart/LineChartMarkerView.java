...
public class LineChartMarkerView extends MarkerView {
    ...
    public void refreshContent(Entry e, Highlight highlight) {
        ...
        if (isSetting){
            if (index == 0) {
                color = BaseApplication.getInstance().getResources().getColor(R.color.colorBlueLine);
            } else {
                color = BaseApplication.getInstance().getResources().getColor(R.color.colorRedLine);
            }
        }else {
            if (index == 0) {
                color = BaseApplication.getInstance().getResources().getColor(R.color.colorRedLine);
