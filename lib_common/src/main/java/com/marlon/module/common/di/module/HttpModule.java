package com.marlon.module.common.di.module;
...
public class HttpModule {
    ...
    OkHttpClient provideClient(OkHttpClient.Builder builder) {
        CookieManger cookieJar =
                new CookieManger(BaseApplication.getInstance());
        File mFile = new File(BaseApplication.getInstance().getCacheDir() + "http");//储存目录
    ...
    Retrofit provideMyRetrofit(Retrofit.Builder builder, OkHttpClient client) {
        return createRetrofit(builder, client, BaseApiService.BASE_URL);
    }
